...
SECRET_KEY = config("DJANGO_SECRET_KEY", default="django-insecure-rsg4@0%65zug4x__lmb_7yvt+-=pibn80ew7ef2onan8rqv39+")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config("DEBUG", default=0)

ALLOWED_HOSTS = config("DJANGO_ALLOWED_HOSTS", "127.0.0.1").split(",")
CSRF_TRUSTED_ORIGINS = config("DJANGO_CSRF_TRUSTED_ORIGINS", "https://127.0.0.1").split(
    ","
)
...
DATABASES = {
    "default": {
        ...
        "USER": config("DATABASE_USERNAME", "projectuser"),
